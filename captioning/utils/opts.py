...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--input_json', type=str, default='data/cocotest.json',
...
if __name__ == '__main__':
    ...
    print(args)
    print()
    sys.argv = [sys.argv[0], '--cfg', 'config/updown_long.yml']
    args1 = parse_opt()
    print(dict(set(vars(args1).items()) - set(vars(args).items())))
    print()
    sys.argv = [sys.argv[0], '--cfg', 'config/updown_long.yml', '--caption_model', 'att2in2']
    args2 = parse_opt()
